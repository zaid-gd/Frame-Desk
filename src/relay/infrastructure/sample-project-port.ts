...
export function createSampleProjectPort(): ProjectPort {
  return {
    ...
    loadProjects: () => [{ id: "demo_alpha", name: "Demo Project Alpha", clientId: "client_demo", projectGroupId: "group_demo", stage: "Client Review", dueDate: "2026-08-15", financialType: "projectValue", lead: "Demo Editor", assignees: ["Demo Editor"], progress: 60, money: 2400, workflowSetup: setup }],
