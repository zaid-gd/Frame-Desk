...
const routes = [
  ...
  ["/templates", 200, ["Templates", "Use template"]],
...
const sourceChecks = [
  ...
  ["src/app/tracker-app.tsx", "function normalizeStoredItem", "stored project normalization"],
  ["src/app/tracker-app.tsx", "function normalizeSalaryState", "stored salary batch normalization"],
  ["src/app/tracker-app.tsx", "normalizeSalaryState(readJson<unknown>(SALARY_STORAGE_KEY", "salary storage malformed-data guard"],
  ["src/app/tracker-app.tsx", "function stringSetting", "stored settings scalar normalization"],
  ["src/app/tracker-app.tsx", "function optionSetting", "stored settings option normalization"],
  ["src/app/tracker-app.tsx", "function colorSetting", "stored settings color normalization"],
  ["src/app/tracker-app.tsx", "function freshDefaultSettings", "fresh default settings factory"],
  ["src/app/tracker-app.tsx", "const teamRoleOptions", "centralized team role options"],
  ["src/app/tracker-app.tsx", "teamRole: optionSetting(storedRecord.teamRole, teamRoleOptions", "stored team role normalization"],
  ["src/app/tracker-app.tsx", "role: optionSetting(item.role, teamRoleOptions", "stored team member role normalization"],
  ["src/app/tracker-app.tsx", "item.trim() ? [item.trim()] : []", "stored workflow stage trimming"],
  ...
  ["src/app/tracker-app.tsx", "Profile Details", "focused settings profile panel"],
