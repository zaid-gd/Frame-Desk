...
const routes = [
  ...
  ["/templates", 200, ["Templates", "Reusable production structures", "Client Campaign Edit", "Use template"]],
...
const sourceChecks = [
  ...
  ["src/app/tracker-app.tsx", "function validateIntegrationConfig", "integration form validation"],
  ...
  ["src/app/tracker-app.tsx", "Loading workspace", "account and data loading state"],
  ...
  ["src/app/tracker-app.tsx", "Client Campaign Edit", "usable project templates"],
