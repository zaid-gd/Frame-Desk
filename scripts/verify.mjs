...
const sourceChecks = [
  ...
  ["src/lib/data-context.tsx", "studioName: \"Frame Desk\"", "non-blank fresh install studio defaults"],
  ...
  ["src/app/tracker-app.tsx", "[cutlab.color.teal, cutlab.color.cyan, cutlab.color.sky", "brand-system accent color swatches"],
  ...
  ["src/app/tracker-app.tsx", "function ProjectDatePicker", "app-native project date picker"],
  ...
  ["src/app/tracker-app.tsx", "function ProjectClientCombobox", "client dropdown with free text entry"],
  ...
  ["src/app/tracker-app.tsx", "<WorkspaceShell", "live workspace shell wrapper"],
  ["src/app/tracker-app.tsx", "<PrecisionDashboard", "live dashboard dispatcher"],
  ["src/app/tracker-app.tsx", "<PrecisionProjects", "live projects dispatcher"],
  ["src/app/tracker-app.tsx", "<PrecisionClients", "live clients dispatcher"],
  ["src/app/tracker-app.tsx", "<PrecisionTimeline", "live timeline dispatcher"],
  ["src/app/tracker-app.tsx", "<PrecisionCalendar", "live calendar dispatcher"],
  ["src/app/tracker-app.tsx", "<PrecisionMedia", "live media dispatcher"],
  ["src/app/tracker-app.tsx", "<PrecisionFeedback", "live feedback dispatcher"],
  ["src/app/tracker-app.tsx", "<PrecisionReports", "live reports dispatcher"],
  ["src/components/workspace-shell.tsx", "const routeGroups: RouteGroup[]", "live workspace navigation configuration"],
  ["src/components/workspace-shell.tsx", "aria-label=\"Primary navigation\"", "live primary navigation landmark"],
  ["src/components/precision-dashboard.tsx", "export function PrecisionDashboard", "live dashboard implementation"],
  ["src/components/precision-schedule.tsx", "export function PrecisionCalendar", "live calendar implementation"],
  ["src/components/precision-schedule.tsx", "export function PrecisionTimeline", "live timeline implementation"],
  ["src/components/precision-workspaces.tsx", "export function PrecisionClients", "live clients implementation"],
  ["src/components/precision-workspaces.tsx", "export function PrecisionFeedback", "live feedback implementation"],
  ["src/components/precision-workspaces.tsx", "export function PrecisionReports", "live reports implementation"],
  ["src/components/precision-media.tsx", "export function PrecisionMedia", "live media implementation"],
  ...
  ["src/components/precision-projects.tsx", "My Projects", "personal project workspace"],
  ["src/components/precision-projects.tsx", "Team Projects", "team project workspace"],
  ["src/components/workspace-shell.tsx", "const [collapsed, setCollapsed] = useState(false);", "collapsible desktop sidebar state"],
  ["src/components/workspace-shell.tsx", "aria-label={collapsed ? \"Expand navigation\" : \"Collapse navigation\"}", "desktop sidebar collapse control"],
  ["src/components/workspace-shell.tsx", "aria-label=\"Go to dashboard\"", "clickable app logo"],
  ...
  ["src/components/workspace-shell.tsx", "page: \"settings\", label: \"Settings\"", "settings navigation destination"],
  ["src/components/workspace-shell.tsx", "aria-label=\"Support and legal\"", "workspace support navigation"],
  ...
  ["src/components/precision-workspaces.tsx", "aria-label=\"Scrollable client directory\"", "keyboard-accessible client directory"],
  ["src/components/precision-schedule.tsx", "aria-label={`Select ${formatDate(key", "keyboard-accessible calendar days"],
  ["src/components/workspace-shell.tsx", "aria-label=\"Open profile menu\"", "labeled profile menu trigger"],
  ["src/components/precision-schedule.tsx", "aria-label=\"Previous month\"", "labeled previous month control"],
  ["src/components/precision-schedule.tsx", "aria-label=\"Next month\"", "labeled next month control"],
  ...
  ["src/app/providers.tsx", "<TooltipProvider delayDuration={250}>", "shared tooltip provider"],
  ["src/app/providers.tsx", "<Toaster", "shared toast provider"],
  ["src/app/design-system.ts", "charcoal: \"#0B0F14\"", "centralized Frame Desk color tokens"],
  ...
  ["src/app/cutlab-brand.tsx", "src=\"/brand/favicon.png\"", "Frame Desk supplied favicon mark asset"],
